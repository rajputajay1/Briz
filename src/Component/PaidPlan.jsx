            ...
            <Box sx={{ px: { md: 3,  }, mt: 2 }}>
                ...
                <Box sx={{ border: '1px solid #394EE1', borderRadius: 2, display: "flex",  justifyContent: "space-between", mt: { md: 5, xs: 2 }, px: { md: 3, xs: 1 } }}>
                    <Box sx={{ maxWidth: { md: 400 }, mt: { md: 3, xs: 2 }, pl: 1, flex: 1 }}>
                        ...
                        <Typography variant="body1" gutterBottom sx={{ mt: 1, fontSize: { xs: 10, md: 18 }, fontWeight: 400, color: "#dddddd" }}>
                            You have Bizchrome’s Lite plan
                            which is your use for 2 month’s so Active with
                            Bizchrome’s plan.
                        </Typography>
                        <Button variant="outlined" sx={{ fontSize: { xs: 10, md: 18 }, fontWeight: 700, color: "#000000", borderRadius: 50, mt: 1, mb: { xs: 2 },  textWrap:"nowrap"}}>
                            Plan start : 2 Apr
                        </Button>
                    </Box>
                    <StyledImage
